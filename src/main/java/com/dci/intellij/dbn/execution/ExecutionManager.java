...
public class ExecutionManager extends AbstractProjectComponent implements PersistentStateComponent<Element> {
    private
    boolean retainStickyNames = false;
    ...
    public void setRetainStickyNames(boolean retainStickyNames) {
        this.retainStickyNames = retainStickyNames;
    }

    public boolean isRetainStickyNames() {
        return this.retainStickyNames;
    }
}
